        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?= base_url('MahasiswaController/setting_profil') ?>"><i class="fas fa-user-cog"></i> &nbsp; Akun</a></li>
                    <li><a class="dropdown-item" href="<?= base_url('MahasiswaController/setting_password') ?>"><i class="fas fa-cog"></i> &nbsp; Password</a></li>
                    <li>
                        <hr class="dropdown-divider" />
                    </li>
                    <li><a class="dropdown-item" onclick="return confirm('Logout?')"  href="<?= base_url('MahasiswaController/logout') ?>">Logout &nbsp; <i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
            </li>
        </ul>
    </nav>