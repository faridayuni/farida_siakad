    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/dosen') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Dosen</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/matakuliah') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Matakuliah</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/jurusan') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Jurusan</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/nilai') ?>">
              <i class="ti-pie-chart menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/materi') ?>">
              <i class="ti-pie-chart menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/setting') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Setting</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('StaffController/logout') ?>">
              <i class="ti-pie-chart menu-icon"></i>
