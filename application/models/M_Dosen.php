...
class M_Dosen extends CI_Model
{
    ...
    public function tampilDataKHS($npm)
    {
        ...
        // $this->db->where($where);
        // $this->db->select('t_krs_khs.periode, t_matakuliah.id_matkul, t_matakuliah.nama_matkul, 
        // t_matakuliah.sks, t_krs_khs.id_krskhs, t_mahasiswa.nama_mhs, t_krs_khs.nilai, t_krs_khs.bobot,
        // t_matakuliah.semester, t_krs_khs.id_nim');
